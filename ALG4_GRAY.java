...
public class ALG4_GRAY {
 ...
 public   void MAIN(String args)  {      
  ...
  //1.the_number_of_tampered_blocks 2. the_total_number_of_blocks 
 //3. the number of detected blocks       
 //4.the number of repaired blocks 5. the number of detected blocks
 // 6.the total number of untampered  blocks
  
   int the_number_of_tampered_blocks=0;
   int the_number_of_untampered_blocks=0;   
  int the_total_number_of_blocks=0; 
  int the_number_of_detected_blocks=0; 
    int the_number_of_repaired_blocks=0;
...
//2. 
 ...
 //7.the total number of tampered blocks 8.the total number of untampered  blocks
 ...
 for (int j=0; j<lim_c  && j%3==0 ;j=j+3)
     ...
     //4.5 match s1 and s' if mismatch occurs mark currnt binary block and color image blok and all the six shares p1 to p6 as tampered
           ...
           if((s[0] !=s_[0]) || (s[1] != s_[1]))
           {
               ...
               the_number_of_tampered_blocks++;
               the_total_number_of_blocks++;
               the_number_of_detected_blocks++;
           ...
           {   //System.out.println("not tampered");
               the_number_of_untampered_blocks++;
               the_total_number_of_blocks++;
 ...
 //1.the_number_of_tampered_blocks 2. the_total_number_of_blocks 
 //3. the number of detected blocks     
 //5.the number of repaired blocks 6. the number of detected blocks
  // 8.the total number of untampered  blocks
 

//unknown
 // 1.the number of tampered blocks marked as untampered)();
//2.the number of untampered blocks marked as tampered;

   
  //tampering ratio=(the number of tampered blocks)/(the total number of blocks);
//detection ratio =(the number of detected blocks)/(the number of tampered blocks);
//repair ratio=(the number of repaired blocks)/(the number of detected blocks);
