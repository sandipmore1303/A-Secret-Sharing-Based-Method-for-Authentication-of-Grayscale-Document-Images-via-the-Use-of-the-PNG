    ...
    //2 convert to grayscale      
     ...
     for (int cx=0;cx<lim_c;cx++) {  
       ...
       for ( int j=0; j<lim_c  && j%3==0 ;j=j+3) 
             ...
             System.out.println();
             System.out.println("("+i+","+j+")"+AI[j][i]+" ("+i+","+(j+1)+")"+AI[j+1][i]+" ("+i+","+(j+2)+") "+AI[j+2][i]);  
             System.out.println("("+(i+1)+","+j+")"+AI[j][(i+1)]+" ("+(i+1)+","+(j+1)+")"+AI[j+1][(i+1)]+" ("+(i+1)+","+(j+2)+") "+AI[j+2][(i+1)]);                   
           }
      ...
      {ntampblk++;
         ...
         // for(int jm=j;jm<j+3;jm++)
          ...
          if(flag==true){//repairable
              ...
              System.out.println("_d="+_d+"_c1="+_c1);
              int S_[]=new int[8];
              int bi[]=new int[6];
              k=0;
